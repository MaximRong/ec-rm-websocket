...
public class RClassPath {
    ...
    public static Resource[] getResources(String classPathPattern) {
        PathMatchingResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
        try {
            String packageSearchPath = ResourcePatternResolver.CLASSPATH_ALL_URL_PREFIX + classPathPattern;
            return resolver.getResources(packageSearchPath);
        }
        catch (Exception e) {
            throw Throwables.propagate(e);
    ...
    public static void main(String[] args) {
        ...
        try {
            String packageSearchPath = ResourcePatternResolver.CLASSPATH_ALL_URL_PREFIX +
                    resolveBasePackage("a") + "/" + "a.a";
            System.out.println(ResourcePatternResolver.CLASSPATH_ALL_URL_PREFIX);
